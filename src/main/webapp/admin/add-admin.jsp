...
<body>
	...
	<div class="home_content">
		<section id="user">
			<h3 class="d-heading">Add Admin</h3>

			<div class="f-out">
				<form action="../register" method="post">
					<input type="text" placeholder="Username" name="runame"> <input
						id="pswrd" type="password" placeholder="Password" name="rpsw">
